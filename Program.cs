...
namespace Calculator
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            string[] testExpressions_1 = { "24 + 3", "0 + 0", "0 + 1", "+ 2", "2 + ", "5 - 2", "2 - 8", "5 + 11 - 3", "5 + 3 - 9", "-10 + 5", "5 - 6 + 10", "4 - 2 - 5", "4 - 4 - 3" };
            double[] testResults_1 = { 24 + 3, 0 + 0, 0 + 1, 2, 2, 5 - 2, 2 - 8, 5 + 11 - 3, 5 + 3 - 9, -10 + 5, 5 - 6 + 10, 4 - 2 - 5, 4 - 4 - 3 };
            string[] testExpressions_2 = { "2 * 3", "1 * 2", "* 2", "4 / 2", "5 * 3", "0 * 2 ", "0*2", "1*4", "5*5", "5^2", "5^0", "0^2"};
            double[] testResults_2 = { 6, 2, 2, 2, 15, 0 , 0, 4, 25, 25, 1, 0 };
